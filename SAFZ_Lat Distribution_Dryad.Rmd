...
# Seal Tracks for map
Daily<-read.csv('Data/Daily_GGBDist.csv')
...
ggsave("Figures/AllSealTracks_FebSep_noLegend_V2.png", ALLGGB, width = 8, height = 6, units = "in", dpi=600)
